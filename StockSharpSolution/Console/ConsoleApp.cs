...
using StockSharpSolution.Services;
using System;
...
namespace StockSharpSolution.Console
{
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            foreach (string securityID in candlesDictionary.Keys)
            {
                ...
                strategy.Stop();
                System.Console.WriteLine("Portfolie End Value: " + (emulationConnection.GetTotalValue() / initialMoney * 100).ToString());
